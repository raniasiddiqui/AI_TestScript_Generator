...
def main():
    ...
    st.markdown("""
<div class="info-card">
    <div class="info-title">🚀 Welcome to the Playwright Test Runner</div>
    Paste a function generated by Playwright codegen and automatically get:
    <ul>
        <li>✔ Full runnable pytest script</li>
        <li>✔ Step-level pass/fail tracking</li>
        <li>✔ Excel execution report</li>
